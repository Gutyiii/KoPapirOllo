...
public class MainForm extends javax.swing.JFrame {
    ...
    String allapot;
    String[] nyertes = {"játékos", "gép"};
    java.util.Random random = new java.util.Random();
    int randomszam = random.nextInt(nyertes.length);
    
    public void ablak(String uzenet){
        JOptionPane.showConfirmDialog(rootPane, this, uzenet, JOptionPane.OK_CANCEL_OPTION);
    }
